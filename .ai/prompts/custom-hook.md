...
- 技术栈: React 18 + TypeScript + ahooks
- 路径别名: @/ 指向 src/
...
2. 代码规范:
   - 使用 TypeScript 严格模式
   - 使用路径别名导入
   - 使用 ahooks 的相关 Hook（如 useRequest、useUpdateEffect 等）
   - 类型定义完整，不使用 any
   - 添加 JSDoc 注释
